...
args: [],
source: "addNewProject\x0a|  taskDate delay|\x0a    taskDate := DateStringParser dateFromString: (( document getElementById: 'input_new_date' ) value, \x0a    \x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09' ', \x0a                                                                        (document getElementById: 'input_new_time') value).\x0a    delay := ( taskDate - Date now ).\x0a    (Date new milliseconds: delay).\x0a    ( [self whatToDoMessage] valueWithTimeout: delay).\x0a    delay <= 0 ifTrue: [ self whatToDoMessage].\x0a   \x22 [window alert: self printMessage ] valueWithTimeout: delay.\x22\x0a   \x09\x22'#print_new_task' asJQuery after: '<p>', taskDate, ': waiting - ' , delay , '</p>'.\x22",
...
args: [],
source: "whatToDoMessage\x0a   (window confirm: 'Declare ') \x0a   ifTrue: [\x0a\x09\x09window open: 'http://ya.ru']\x0a   ifFalse: [ \x0a  \x09\x09window alert: self printMessage, '2']\x0a    \x22 '#later' asJQuery click: [ self addNewProject]\x22",
